...
<div class="body-contents-wrapper">
	...
	<div class="input-area row">
		...
		<div class="col-3 custom-file" style="margin-left:15px;">
			 <input type="file" class="custom-file-input" name="skill_icon" id="skill_icon" multiple="multiple">
